...
public class PredefinedTileSets {
    ...
    public static List<Tile> derdePlatform(){
    	int[][] map = {
    			{50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 9},
    			{50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 9, 10},
    			{50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 9, 10, 11},
    			{50, 50, 50, 9, 50, 50, 50, 50, 50, 9, 50, 50, 9, 11, 50, 50},
    			{50, 50, 9, 11, 9, 50, 50, 50, 9, 10, 9, 9, 9, 50, 50, 50, },
    			{50, 50, 11, 11, 50, 9, 6, 9, 11, 11, 50, 50, 50, 50, 50, 50},
    			{9, 9, 11, 11}
    	};
    	return TileGenerator.generateTiles(map, 1300, 700);
    }
    
    public static List<Tile> vierdePlatform() {
    	int[][] map = {
    			{50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 0, 0, 0},
    			{50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 0, 1, 50, 50},
    			{50, 50, 0, 0, 0, 50, 50, 50, 50, 50, 50, 50, 0, 0, 1, 1, 50, 50}
    			
    	};
    	return TileGenerator.generateTiles(map, 2300, 700);
    }
